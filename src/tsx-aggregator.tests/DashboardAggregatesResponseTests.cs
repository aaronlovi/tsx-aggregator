...
public class DashboardAggregatesResponseTests {
    ...
    public void DashboardAggregatesResponse_ShouldPreserveAllFields() {
        ...
        var scoreCategoryStatistics = new List<ScoreCategoryStats> {
            new(Score: 13, Count: 5, SumMarketCap: 500_000_000M, MeanMarketCap: 100_000_000M,
            ...
            new(Score: 12, Count: 10, SumMarketCap: 800_000_000M, MeanMarketCap: 80_000_000M,
        ...
        _ = response.ScoreCategoryStatistics[0].Score.Should().Be(13);
        _ = response.ScoreCategoryStatistics[0].SumMarketCap.Should().Be(500_000_000M);
        _ = response.ScoreCategoryStatistics[1].Score.Should().Be(12);
